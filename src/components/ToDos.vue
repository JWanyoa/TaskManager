<template>
               ...
               <div class="card-body">
                  <div class="todo-types">
                     <div class="incomplete" v-if="incompleteTodos.length > 0">
                        <ul class="list-group">
                           <li class="list-group-item list-group-item-warning" @click="toggleTodo(todo.id, todo.completed)"  v-for="todo in incompleteTodos" v-bind:key="todo.id">{{ todo.title }}</li>
                        </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class="card-body">
                  <div class="todo-types">
                     <div class="complete" v-if="completeTodos.length > 0">
                        <ul class="list-group">
                           <li class="list-group-item list-group-item-success" @click="toggleTodo(todo.id, todo.completed)"  v-for="todo in completeTodos" v-bind:key="todo.id">{{ todo.title }}</li>
                        </ul>
                     </div>
                  </div>
               </div>
 ...
 <script>
    ...
    export default{
        ...
        methods:
        {
            ...
            addTask()
            {
                ...
                //     'date_completed' = date_completed.value
                // ],
               //  this.$store.todos.push({title:this.title, description:this.description, date_added:this.date_added, deadline:this.deadline, date_completed:this.date_completed,})
    ...
    //       $('#addr'+i).html("<td>"+ (i+1) +"</td><td><input name='title"+i+"' type='text' placeholder='Title' class='form-control input-md'  /> </td><td><input  name='description"+i+"' type='text' placeholder='Description'  class='form-control input-md'></td><td><input  name='date_added"+i+"' type='date' placeholder='Date Added'  class='form-control input-md'></td><td><input  name='deadline"+i+"' type='text' placeholder='Deadline'  class='form-control input-md'></td><td><input  name='date_completed"+i+"' type='date' placeholder='Date Completed'  class='form-control input-md'></td>");
